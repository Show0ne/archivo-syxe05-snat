...
Function oTaskSequences
	...
	'oDebugging.WriteLog "oTaskSequences",LogTypeInfo
	'oDebugging.ShowMessage oUtility.ScriptName & " oTaskSequences()",InitializationTimeout,oUtility.ScriptName
...
function CustomTSFilter( sGuid, oItem )
	'oShell.Popup "DeployWiz_Initialization.vbs", 0, "DeployWiz_Initialization.vbs CustomTSFilter", 64
...
Function FindTaskSequenceStep(sStepType, sScriptCmd )
	...
	'oDebugging.WriteLog "FindTaskSequenceStep",LogTypeInfo
	'oDebugging.ShowMessage oUtility.ScriptName & " FindTaskSequenceStep()",InitializationTimeout,oUtility.ScriptName
