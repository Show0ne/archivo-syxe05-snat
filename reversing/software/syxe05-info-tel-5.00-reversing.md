# Info Tel v5.00 – Reversing Tutorial
...
En este tutorial se analiza **Info Tel v5.00**, una aplicación Windows incluida
en la colección de tutoriales de reversing de SyXe'05. El programa utiliza un
sistema de registro para habilitar todas sus funcionalidades.

El objetivo del análisis es localizar la rutina encargada de comprobar si el
programa está registrado y comprender el mecanismo de validación del número de
serie.
