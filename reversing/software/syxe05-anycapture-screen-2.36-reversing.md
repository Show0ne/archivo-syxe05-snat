...
En este tutorial se analizará el sistema de protección utilizado por **AnyCapture Screen 2.36**.

Las aplicaciones shareware suelen implementar mecanismos de registro basados en la introducción de un nombre y un serial que posteriormente es validado por el programa.
...
En este tutorial se ha analizado el sistema de registro utilizado por **AnyCapture Screen 2.36**.
