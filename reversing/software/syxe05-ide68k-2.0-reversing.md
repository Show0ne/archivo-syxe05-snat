...
En este tutorial se analizará el sistema de protección utilizado por **Ide68k 2.0**.

Este tipo de aplicaciones shareware suelen utilizar mecanismos de registro basados en la introducción de un nombre y un serial que es validado por el programa.
...
En este tutorial se ha analizado el sistema de registro utilizado por **Ide68k 2.0**.
