# Alchemy Network Inventory 1.4.12
...
En este tutorial se analizará el sistema de protección utilizado por **Alchemy Network Inventory 1.4.12**.

Las aplicaciones shareware suelen utilizar mecanismos de registro basados en la introducción de un nombre y un serial que posteriormente es validado por el programa.
...
Introducimos un nombre y un serial cualquiera para provocar que el programa ejecute la rutina de validación.
...
En este tutorial se ha analizado el sistema de registro utilizado por **Alchemy Network Inventory 1.4.12**.
